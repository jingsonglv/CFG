...
nohup python3 train.py --cmd_time ${cmd_time} --eval_hits_K 45 60 75 100 --device 1 --ngnn_code --grpe_cross --num_heads 8 --ngnn_type input --num_ngnn_layers 1 --hidden_channels 96 --dataset ogbl-ppa --use_feature --use_feature_GT --epochs 1 --train_percent 60 --val_percent 40 --test_percent 1 --model NGNNDGCNNGraphormer_noNeigFeat --runs 10 --batch_size 128 --lr 0.00015 --num_workers 48 --dynamic_train --dynamic_val --dynamic_test --use_len_spd --use_num_spd --use_cnb_jac --use_cnb_aa --use_cnb_ra --use_cnb_swing >> train_log/run_${cmd_time}.log 2>&1 &
